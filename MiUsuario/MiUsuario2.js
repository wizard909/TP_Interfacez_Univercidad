...
function desplegarUsuario(numero){
    ...
    <textarea name="" id="" cols="30" rows="2" maxlength="100" class="nombreTextEdit" >${datos.Usuarios[1].Nombre}</textarea>
    <textarea name="" id="" cols="30" rows="2" maxlength="50" class="contraceniaTextEdit" >${datos.Usuarios[1].Contrasenia}</textarea>
    <textarea name="" id="" cols="30" rows="2" maxlength="50" class="activoTextEdit" >${datos.Usuarios[1].Activo}</textarea>
